...
"></button>
                    ...
                    <a href="#" class="small" onclick="event.preventDefault(); window.asfHandleModalAction('enter_key')">Working on a local site? Enter your key instead.</a>
                        ...
                        <div class="col-lg-6">
                            <div class="card rounded-0 m-0 border-0 p-4 p-md-5 d-flex flex-column justify-content-top h-100">
                                ...
                                <p class="text-muted mb-4">Get the <strong>${t.info.title}</strong> extension and much more with a membership.</p>
                                <ul class="list-unstyled mb-4">
                                ...
                                <div class="text-center mt-3">
                                    <a href="${t.info.link}" target="_blank" class="small">Just want to purchase this one extension?</a>
                                </div>
                            </div>
                        </div>
                    </div>
            `;aui_modal("",a,"",!0,"aui-premium-modal","modal-lg","p-0 rounded overflow-hidden"),window.asfHandleModalAction=r=>{const c=document.querySelector(".aui-premium-modal.show");c&&bootstrap.Modal.getInstance(c)?.hide(),(r==="connect"||r==="enter_key")&&this.$dispatch("navigate-to-section",{sectionId:"membership"})}},async do_ajax(t,s){let i={action:window.ayecodeSettingsFramework.tool_ajax_action,nonce:window.ayecodeSettingsFramework.tool_nonce,tool_action:t,item_data:JSON.stringify(s)};try{const o=await(await fetch(window.ayecodeSettingsFramework.ajax_url,{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:new URLSearchParams(i)})).json();return!o.success&&!o.data?.guidance_needed&&b(this,o.data?.message||"An unexpected error occurred. Please try again.","error"),o}catch{return b(this,"A network error occurred. Please check your connection and try again.","error"),{success:!1,data:{message:"Network error."}}}}}}const C=new Map;let S=typeof window<"u"?window.asfFieldRenderer:void 0;function u(e,t){C.set(e,t)}function $e(e,t="settings"){if(!e||!e.type)return'<div class="alert alert-warning">Invalid field configuration</div>';const s=C.get(e.type);if(typeof s=="function")try{return s(e,t)}catch(n){return console.error(`Renderer for type "${e.type}" threw:`,n),`<div class="alert alert-danger">Error rendering field type: ${e.type}</div>`}const i=window.__asfFieldRendererLegacy||S;return i&&typeof i.renderField=="function"?i.renderField(e,t):`<div class="alert alert-info">Unsupported field type: ${e.type}</div>`}const D=e=>"render"+e.charAt(0).toUpperCase()+e.slice(1)+"Field";function m(e,t,s="settings"){const i=C.get(e);if(typeof i=="function")try{return i(t,s)}catch(o){console.error(`Renderer "${e}" error:`,o)}const n=window.__asfFieldRendererLegacy||S;return n&&typeof n[D(e)]=="function"?n[D(e)](t,s):n&&typeof n.renderField=="function"?n.renderField(t,s):`<div class="alert alert-info">Unsupported field type: ${e}</div>`}const Se=(e,t)=>m("text",e,t),Fe=(e,t)=>m("email",e,t),ke=(e,t)=>m("url",e,t),xe=(e,t)=>m("alert",e,t),Ce=(e,t)=>m("password",e,t),Le=(e,t)=>m("google_api_key",e,t),Pe=(e,t)=>m("number",e,t),Ae=(e,t)=>m("textarea",e,t),Ee=(e,t)=>m("toggle",e,t),Oe=(e,t)=>m("select",e,t),je=(e,t)=>m("color",e,t),Ne=(e,t)=>m("range",e,t),Te=(e,t)=>m("checkbox",e,t),Ie=(e,t)=>m("radio",e,t),De=(e,t)=>m("multiselect",e,t),Je=(e,t)=>m("checkbox_group",e,t),Me=(e,t)=>m("group",e,t),Re=(e,t)=>m("image",e,t),Ve=(e,t)=>m("hidden",e,t),Ue=(e,t)=>m("file",e,t),He=(e,t)=>m("font-awesome",e,t),qe=(e,t)=>m("gd_map",e,t),Be=(e,t)=>m("helper_tags",e,t),We=(e,t)=>m("action_button",e,t),Ge=(e,t)=>m("link_button",e,t),ze=(e,t)=>m("custom_renderer",e,t);(function(){typeof window>"u"||(S&&(window.__asfFieldRendererLegacy=S),window.asfFieldRenderer={renderField:$e,renderTextField:Se,renderEmailField:Fe,renderUrlField:ke,renderAlertField:xe,renderPasswordField:Ce,renderGoogleApiKeyField:Le,renderNumberField:Pe,renderTextareaField:Ae,renderToggleField:Ee,renderSelectField:Oe,renderColorField:je,renderRangeField:Ne,renderCheckboxField:Te,renderRadioField:Ie,renderMultiselectField:De,renderCheckboxGroupField:Je,renderGroupField:Me,renderImageField:Re,renderHiddenField:Ve,renderFileField:Ue,renderIconField:He,renderGdMapField:qe,renderHelperTagsField:Be,renderActionButtonField:We,renderLinkButtonField:Ge,renderCustomField:ze,__registerRenderer:u})})();function Ke(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function J(e){return String(e).replace(/"/g,"&quot;")}function w(e){if(!e?.extra_attributes||typeof e.extra_attributes!="object")return"";const t=[];for(const[s,i]of Object.entries(e.extra_attributes)){const n=s.replace(/[^a-zA-Z0-9-]/g,"");n&&(i===!0?t.push(n):t.push(`${n}="${Ke(i)}"`))}return t.join(" ")}u("hidden",e=>{const t=w(e);return`<input type="hidden" id="${e.id}" name="${e.id}" x-model="settings.${e.id}" ${t}>`}),u("alert",e=>`
    <div class="alert alert-${e.alert_type||"info"} mb-0">
      ${e.label?`<h6 class="alert-heading">${e.label}</h6>`:""}
      ${e.description||""}
    </div>
  `);function p(e){return e?.custom_desc?`<div class="form-text mt-2">${e.custom_desc}</div>`:""}u("text",L),u("email",L),u("url",L);function L(e){const t=e.class||"",s=w(e),i=J(e.placeholder||"");let n="";if(e.active_placeholder&&e.placeholder){const l=JSON.stringify(e.placeholder);n=`
  ...
  `}u("password",e=>{const t=e.class||"",s=w(e),i=p(e),n=`<input type="password" autocomplete="new-password" class="form-control ${t}" id="${e.id}" name="${e.id}" x-model="settings.${e.id}" placeholder="${e.placeholder||""}" ${s}>`,o=e.input_group_right?`<div class="input-group">${n}${e.input_group_right}</div>`:n;return`
    <div class="row align-items-center rounded">
      <div class="col-md-4">
        <label for="${e.id}" class="form-label fw-bold mb-0">${e.label||e.id}</label>
        ${e.description?`<p class="form-text text-muted mt-1 mb-0">${e.description}</p>`:""}
  ...
  `}),u("textarea",e=>{const t=e.rows||5,s=e.class||"",i=w(e),n=J(e.placeholder||""),o=p(e);let a="";if(e.active_placeholder&&e.placeholder){const r=JSON.stringify(e.placeholder);a=`
  ...
  `}),u("toggle",(e,t="settings")=>{const s=w(e),i=p(e),o=`${`${t}.${e.id}`} = $event.target.checked ? 1 : 0;`;return`
    <div class="row align-items-center rounded">
      <div class="col-md-4">
        <label for="${e.id}" class="form-label fw-bold mb-0">${e.label||e.id}</label>
        ${e.description?`<p class="form-text text-muted mt-1 mb-0">${e.description}</p>`:""}
  ...
  `}),u("range",e=>{const t=e.min||0,s=e.max||100,i=e.step||1,n=w(e),o=p(e);return`
    <div class="row align-items-center rounded">
      <div class="col-md-4">
        <label for="${e.id}" class="form-label fw-bold mb-0">${e.label||e.id}</label>
        ${e.description?`<p class="form-text text-muted mt-1 mb-0">${e.description}</p>`:""}
  ...
  `}),u("checkbox",e=>{const t=w(e),s=p(e);return`
    <div class="row">
      <div class="col-md-4">
  ...
  `}),u("accordion",e=>{if(!e.fields||!Array.isArray(e.fields))return'<div class="alert alert-warning">Accordion field requires a "fields" array.</div>';const t=`accordion-${e.id}`;let s=`<div class="accordion" id="${t}" x-data="{ isChoicesOpen: false }">`;return e.fields.forEach(i=>{if(!i.id||!i.fields||!Array.isArray(i.fields))return;const n=i.id,o=`heading-${n}`,a=`collapse-${n}`,r=e.default_open===n;s+=`
        ...
        </div>`}),s+="</div>",s}),u("image",e=>{const t=p(e);return`
    <div class="row">
      <div class="col-md-4">
        <label class="form-label fw-bold mb-0">${e.label||e.id}</label>
        ${e.description?`<p class="form-text text-muted mt-1 mb-0">${e.description}</p>`:""}
  ...
  `}),u("color",e=>{const t=w(e),s=p(e),i=e.default?`
    <button 
      type="button" 
  ...
  `}),u("font-awesome",e=>{const t=e.class||"",s=w(e),i=p(e),n=e.input_group_right||"";return`
    <div class="row align-items-center rounded">
      <div class="col-md-4">
        <label for="${e.id}" class="form-label fw-bold mb-0">${e.label||e.id}</label>
        ${e.description?`<p class="form-text text-muted mt-1 mb-0">${e.description}</p>`:""}
  ...
  `}),u("action_button",e=>{const t=p(e),s=`actionStates['${e.id}']`;if(e.toggle_config){const n=e.toggle_config.insert||{},o=e.toggle_config.remove||{};return`
  ...
  `}),u("link_button",e=>{const t=e.url||"#",s=e.button_text||"Click Here",i=e.button_class||"btn-secondary",n=e.target?`target="${e.target}"`:"",o=e.target==="_blank"?'rel="noopener noreferrer"':"",a=`<a href="${t}" class="btn ${i}" ${n} ${o}>${s}</a>`,r=p(e);return`
    <div class="row align-items-center rounded">
      <div class="col-md-4">
        <label class="form-label fw-bold mb-0">${e.label||e.id}</label>
        ${e.description?`<p class="form-text text-muted mt-1 mb-0">${e.description}</p>`:""}
  ...
  `}),u("gd_map",e=>{if(!e.lat_field||!e.lng_field)return`<div class="alert alert-danger">Error: 'gd_map' field type requires 'lat_field' and 'lng_field' properties.</div>`;const t=`${e.id}_map_canvas`,s=w(e),i=p(e);return`
  ...
  `}),u("custom_renderer",e=>!e.renderer_function||typeof e.renderer_function!="string"?`<div class="alert alert-danger">Error: 'custom_renderer' field type requires a 'renderer_function' property specifying the function name.</div>`:typeof window[e.renderer_function]!="function"?`<div class="alert alert-danger">Error: The specified renderer function '${e.renderer_function}' was not found or is not a function.</div>`:window[e.renderer_function](e)),u("conditions",e=>{const t=e&&e.warning_key?String(e.warning_key):null,s=Array.isArray(e&&e.warning_fields)?e.warning_fields.slice(0):[],i=t&&/^[A-Za-z_$][A-Za-z0-9_$]*$/.test(t)?t:null,n=i&&s.length?s.map(a=>`editingField && editingField.${i}===${JSON.stringify(a)}`).join(" || "):"",o=n.replace(/"/g,"&quot;");return`
    ...
    `}),u("file",e=>{const t=w(e),s=e.accept||"",i=p(e);return`
    <div class="row align-items-center rounded">
      <div class="col-md-4">
        <label for="${e.id}" class="form-label fw-bold mb-0">${e.label||e.id}</label>
        ${e.description?`<p class="form-text text-muted mt-1 mb-0">${e.description}</p>`:""}
