...
registerRenderer('checkbox_group', (field) => {
    let optionsHtml = '';
    ...
    if (field.options) {
        ...
        <div class="form-check">
          <input class="form-check-input" type="checkbox" value="${val}" id="${field.id}_${val}" name="${field.id}" x-model="settings.${field.id}" ${extra}>
