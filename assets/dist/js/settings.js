(function(){"use strict";function J(e){e.config?.sections&&(e.sections=e.config.sections.map(t=>({...t})))}function V(e){e.allFields=[];const t=(s,i,n=null)=>{Array.isArray(s)&&s.forEach(o=>{o&&(o.type==="group"&&o.fields?t(o.fields,i,n):o.id&&o.searchable!==!1&&e.allFields.push({type:"field",field:o,sectionId:i.id,sectionName:i.name,subsectionId:n?n.id:null,subsectionName:n?n.name:null,icon:i.icon}))})};e.sections.forEach(s=>{e.allFields.push({type:"section",id:s.id,name:s.name,icon:s.icon,keywords:s.keywords||[]}),t(s.fields,s),s.subsections?.forEach(i=>{e.allFields.push({type:"subsection",id:i.id,name:i.name,icon:s.icon,sectionId:s.id,sectionName:s.name,keywords:i.keywords||[]}),t(i.fields,s,i)})})}function v(e){if(Array.isArray(e)){if(e.length===0)return;const t=e.map(v).filter(s=>s!==void 0);return t.length>0?t:void 0}if(typeof e=="object"&&e!==null){const t=Object.entries(e).reduce((s,[i,n])=>{const o=v(n);return o!==void 0&&(s[i]=o),s},{});return Object.keys(t).length===0?void 0:t}return e}function P(e){const t=e.activePageConfig;if(!t||["form_builder","custom_page","action_page","import_page","tool_page","extension_list_page"].includes(t.type))return!1;const i=t.fields,n=Array.isArray(i)?i:typeof i=="object"&&i!==null?Object.values(i):[];if(n.length===0)return!1;const o=a=>{const r=["title","group","alert","action_button"];return a.some(c=>{if(c.type==="group"&&c.fields){const l=Array.isArray(c.fields)?c.fields:Object.values(c.fields);return o(l)}return!r.includes(c.type)})};return o(n)}function H(e){const t=e.activePageConfig;if(!t)return!1;if(t.type==="form_builder"){const s=t.id,i=e.settings[s]||[],n=e.originalSettings[s]||[],o=JSON.parse(JSON.stringify(i)).map(l=>(delete l.fields,l)),a=JSON.parse(JSON.stringify(n)).map(l=>(delete l.fields,l)),r=v(o),c=v(a);return JSON.stringify(r)!==JSON.stringify(c)}if(P(e)){const s=Array.isArray(t.fields)?t.fields:Object.values(t.fields||{}),i=n=>{for(const o of n)if(o.type==="group"&&o.fields){const a=Array.isArray(o.fields)?o.fields:Object.values(o.fields);if(i(a))return!0}else if(o.id){const a=e.settings[o.id],r=e.originalSettings[o.id];if(JSON.stringify(a)!==JSON.stringify(r))return!0}return!1};return i(s)}return!1}function q(e){if(!e.activePageConfig||!e.activePageConfig.fields)return!0;document.querySelectorAll(".asf-field-error").forEach(s=>s.classList.remove("asf-field-error"));const t=Array.isArray(e.activePageConfig.fields)?e.activePageConfig.fields:Object.values(e.activePageConfig.fields);for(const s of t)if(s.extra_attributes?.required){const i=e.settings[s.id];if(i===""||i===null||i===void 0||Array.isArray(i)&&i.length===0){e.showNotification(`Error: The "${s.label||s.id}" field is required.`,"error");const n=document.getElementById(s.id);if(n){const o=n.closest(".row");o&&(o.classList.add("asf-field-error"),o.scrollIntoView({behavior:"smooth",block:"center"}),setTimeout(()=>o.classList.remove("asf-field-error"),3500))}return!1}}return!0}async function B(e){if(!q(e))return!1;e.isLoading=!0;try{const s=await(await fetch(window.ayecodeSettingsFramework.ajax_url,{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:new URLSearchParams({action:window.ayecodeSettingsFramework.action,nonce:window.ayecodeSettingsFramework.nonce,settings:JSON.stringify(e.settings)})})).json();return s.success?(e.settings=s.data.settings,e.originalSettings=JSON.parse(JSON.stringify(e.settings)),e.originalImagePreviews=JSON.parse(JSON.stringify(e.imagePreviews)),e.showNotification(s.data?.message||e.strings.saved,"success"),!0):(e.showNotification(s.data?.message||e.strings.error,"error"),!1)}catch(t){return console.error("Save error:",t),e.showNotification(e.strings.error,"error"),!1}finally{e.isLoading=!1}}async function W(e){e.isLoading=!0;const t=e.activePageConfig.id,s=e.config.sections.find(a=>a.id===t),i=e.editingField?e.editingField._uid:null,n=JSON.parse(JSON.stringify(e.settings[t]));n.forEach(a=>delete a.fields);const o={[t]:n};try{const r=await(await fetch(window.ayecodeSettingsFramework.ajax_url,{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:new URLSearchParams({action:window.ayecodeSettingsFramework.action,nonce:window.ayecodeSettingsFramework.nonce,settings:JSON.stringify(o),is_partial_save:!0})})).json();if(r.success){const c=r.data.settings[t],l=s.templates.flatMap(u=>u.options),d=c.map(u=>{const p=l.find(m=>m.id===u.template_id);return p&&(u.fields=p.fields),u});if(e.settings[t]=d,e.originalSettings[t]=JSON.parse(JSON.stringify(d)),i&&i.toString().startsWith("new_")){const u=d.find(p=>p.template_id===e.editingField.template_id&&!e.originalSettings[t].some(m=>m._uid===p._uid));u&&(e.editingField=u)}return e.leftColumnView="field_list",e.editingField=window.__ASF_NULL_FIELD,e.showNotification(r.data?.message||e.strings.form_saved,"success"),!0}else return e.showNotification(r.data?.message||e.strings.error,"error"),!1}catch(a){return console.error("Save error:",a),e.showNotification(e.strings.error,"error"),!1}finally{e.isLoading=!1}}async function G(e,t=!0){const s=()=>{e.settings=JSON.parse(JSON.stringify(e.originalSettings)),e.imagePreviews=JSON.parse(JSON.stringify(e.originalImagePreviews))};t?await aui_confirm(e.strings.confirm_discard,"Discard","Cancel",!0,!0)&&s():s()}function j(e,t="settings"){let s="";if(window.asfFieldRenderer){const i="render"+e.type.charAt(0).toUpperCase()+e.type.slice(1)+"Field";typeof window.asfFieldRenderer[i]=="function"?s=window.asfFieldRenderer[i](e):typeof window.asfFieldRenderer.renderField=="function"?s=window.asfFieldRenderer.renderField(e):s=`<div class="alert alert-warning">Field renderer for type "${e.type}" not found.</div>`}else s=`<div class="alert alert-warning">Field renderer for type "${e.type}" not found.</div>`;if(t!=="settings"){const i=new RegExp('(x-model|:checked|@click|@focus|x-show)="(settings|\\s*settings)\\.',"g");s=s.replace(i,`$1="${t}.`)}return s}async function y(e,t){if(e.loadedContentCache[t])return;const s=e.sections.find(i=>i.id===t);if(s?.ajax_content){e.isContentLoading=!0;try{const n=await(await fetch(window.ayecodeSettingsFramework.ajax_url,{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:new URLSearchParams({action:window.ayecodeSettingsFramework.content_pane_ajax_action,nonce:window.ayecodeSettingsFramework.tool_nonce,content_action:s.ajax_content})})).json();e.loadedContentCache[t]=n.success?n.data.html:`<div class="alert alert-danger">Error: ${n.data?.message||"Could not load content."}</div>`}catch{e.loadedContentCache[t]='<div class="alert alert-danger">Request failed while loading content.</div>'}finally{e.isContentLoading=!1}}}function $(e){return e.sections.find(t=>t.id===e.currentSection)}function T(e){const t=$(e);return t?.subsections?t.subsections.find(s=>s.id===e.currentSubsection):null}function K(e){return T(e)||$(e)||null}function F(e){if(e.sections.length>0){e.currentSection=e.sections[0].id;const t=$(e);t?.subsections?.length>0&&(e.currentSubsection=t.subsections[0].id),t?.type==="custom_page"&&t.ajax_content&&y(e,e.currentSection)}b(e)}function N(e){const t=window.location.hash.substring(1);if(!t){F(e);return}const s=new URLSearchParams(t),i=s.get("section"),n=s.get("subsection"),o=s.get("field"),a=e.sections.find(r=>r.id===i);a?(e.currentSection=i,a?.type==="custom_page"&&a.ajax_content&&y(e,i),n&&a.subsections?.some(r=>r.id===n)?e.currentSubsection=n:e.currentSubsection=a.subsections?.length?a.subsections[0].id:""):F(e),o&&e.highlightField(o)}function b(e,t=null){const s=new URLSearchParams;e.currentSection&&s.set("section",e.currentSection),e.currentSubsection&&s.set("subsection",e.currentSubsection),t&&s.set("field",t);const i=s.toString();history.replaceState(null,"",i?`#${i}`:window.location.pathname+window.location.search)}function Q(e,t,s=""){e.changeView(()=>{e.currentSection=t;const i=e.sections.find(n=>n.id===t);e.currentSubsection=s||(i?.subsections?.length?i.subsections[0].id:""),e.searchModal?.hide?.(),b(e),i?.type==="custom_page"&&i.ajax_content&&y(e,t)})}function Y(e,t){e.changeView(()=>{e.currentSection=t,e.sidebarOpen=!1;const s=e.sections.find(i=>i.id===t);e.currentSubsection=s?.subsections?.length?s.subsections[0].id:"",b(e),s?.type==="custom_page"&&s.ajax_content&&y(e,t)})}function Z(e,t){e.currentSubsection!==t&&e.changeView(()=>{e.currentSubsection=t,b(e)})}function X(e){e.searchModalEl=document.getElementById("asf-search-modal"),e.searchModalEl&&(e.searchModal=new bootstrap.Modal(e.searchModalEl),e.searchModalEl.addEventListener("shown.bs.modal",()=>document.getElementById("asf-search-input")?.focus()),e.searchModalEl.addEventListener("hidden.bs.modal",()=>e.searchQuery=""))}function ee(e){if(!e.searchQuery.trim())return[];const t=e.searchQuery.toLowerCase().trim(),n=e.allFields.filter(a=>a.type==="field").filter(a=>{const r=a.field;return[r.label,r.description,a.sectionName,a.subsectionName,...r.keywords||[]].join(" ").toLowerCase().includes(t)}).reduce((a,r)=>{const c=r.subsectionName||r.sectionName,l=r.subsectionName?`${r.sectionName} &raquo; ${r.subsectionName}`:r.sectionName;return a[c]||(a[c]={groupTitle:l,sectionIcon:r.sectionIcon,results:[],sectionId:r.sectionId,subsectionId:r.subsectionId}),a[c].results.push(r),a},{}),o=(e.customSearchLinks||[]).filter(a=>[a.title,a.description,...a.keywords||[]].join(" ").toLowerCase().includes(t));return o.length&&(n.helpful_links={groupTitle:"Helpful Links",sectionIcon:"fas fa-fw fa-external-link-alt",results:o,isCustomGroup:!0}),Object.values(n)}function te(e,t){e.changeView(()=>{e.currentSection=t.sectionId,e.currentSubsection=t.subsectionId||"",e.searchModal.hide(),e.updateUrlHash(t.field.id),e.$nextTick(()=>e.highlightField(t.field.id))})}function se(e,t){e.searchModal?.hide?.(),t.external?window.open(t.url,"_blank"):window.location.href=t.url}function ie(e){const t=s=>{(s.type==="action_page"||s.type==="import_page"||s.type==="tool_page")&&ne(e,s)};e.sections.forEach(s=>{t(s),s.subsections?.forEach(t)}),e.allFields.forEach(s=>{if(s.type==="field"&&s.field.type==="action_button")if(s.field.toggle_config){const i=s.field.has_dummy_data||!1;e.actionStates[s.field.id]={has_dummy_data:i,isLoading:!1,message:"",progress:0,success:null},e.settings[s.field.id]=i}else e.actionStates[s.field.id]={isLoading:!1,message:"",progress:0,success:null}})}function ne(e,t){const s=n=>{Array.isArray(n)&&n.forEach(o=>{o&&(o.id&&e.settings[o.id]===void 0&&o.default!==void 0?e.settings[o.id]=o.default:o.id&&e.settings[o.id]===void 0&&(e.settings[o.id]=""),o.type==="group"&&o.fields&&s(o.fields))})};s(t.fields);let i={isLoading:!1,message:"",progress:0,success:null,exportedFiles:[]};t.type==="import_page"&&(i={...i,uploadedFilename:"",uploadProgress:0,processingProgress:0,status:"idle",summary:{}}),e.actionStates[t.id]=i}function oe(e){return Object.values(e.actionStates).some(t=>t.isLoading)}async function ae(e){const t=e.activePageConfig;if(!t||!t.ajax_action){console.error("Action page configuration not found.");return}const s=e.actionStates[t.id];s.isLoading=!0,s.message="Starting...",s.progress=0,s.processingProgress=0,s.success=null,s.exportedFiles=[],t.type==="import_page"&&(s.status="processing");const i={};if(t.fields?.forEach(o=>{o.id&&(i[o.id]=e.settings[o.id])}),t.type==="import_page"){const o=e.actionStates[t.id];o?.uploadedFilename&&(i.import_filename=o.uploadedFilename)}const n=async o=>{try{const a={action:window.ayecodeSettingsFramework.tool_ajax_action,nonce:window.ayecodeSettingsFramework.tool_nonce,tool_action:t.ajax_action,step:o,input_data:JSON.stringify(i)},r=await fetch(window.ayecodeSettingsFramework.ajax_url,{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:new URLSearchParams(a)});if(!r.ok)throw new Error(`Server responded with status: ${r.status}`);const c=await r.json();s.success=c.success,c.data?.message&&(s.message=c.data.message);const l=c.data?.progress||0;c.data?.summary&&(s.summary=c.data.summary),t.type==="import_page"?s.processingProgress=l:s.progress=l,c.success&&c.data?.file&&s.exportedFiles.push(c.data.file),c.success&&c.data?.next_step!==null&&l<100?setTimeout(()=>n(c.data.next_step),20):(s.isLoading=!1,t.type==="import_page"&&(s.status="complete"))}catch(a){s.success=!1,s.message="An error occurred. Please check the console and try again.",s.isLoading=!1,t.type==="import_page"&&(s.status="complete"),console.error("Page action failed:",a)}};n(0)}async function re(e,t){const s=e.allFields.find(d=>d.type==="field"&&d.field.id===t);if(!s){console.error("Action button configuration not found for:",t);return}const i=s.field,n=e.actionStates[t];let o;if(i.toggle_config?o=n.has_dummy_data?i.toggle_config.remove.ajax_action:i.toggle_config.insert.ajax_action:o=i.ajax_action,!o){console.error("No ajax_action defined for:",t);return}n.isLoading=!0,n.message=e.strings.starting,n.progress=0,n.success=null;const a={};let c=document.getElementById(t)?.closest?.(".card-body")||e.$refs["action_container_"+t]||null;c&&c.querySelectorAll("input, select, textarea").forEach(u=>{const p=u.getAttribute("data-id")||u.id;p&&(a[p]=u.type==="checkbox"?u.checked:u.value)});const l=async d=>{try{const u={action:window.ayecodeSettingsFramework.tool_ajax_action,nonce:window.ayecodeSettingsFramework.tool_nonce,tool_action:o,step:d,input_data:JSON.stringify(a)},p=await fetch(window.ayecodeSettingsFramework.ajax_url,{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:new URLSearchParams(u)});if(!p.ok)throw new Error(`Server responded with an error: ${p.status}`);const m=await p.json();n.success=m.success,m.data?.message&&(n.message=m.data.message),m.data?.progress&&(n.progress=m.data.progress),m.success&&m.data?.next_step!==null&&m.data?.progress<100?setTimeout(()=>l(m.data.next_step),20):(n.isLoading=!1,m.success&&i.toggle_config&&(n.has_dummy_data=!n.has_dummy_data,e.settings[t]=n.has_dummy_data),n.success&&setTimeout(()=>{n.message="",n.success=null},8e3))}catch(u){n.success=!1,n.message=e.strings.something_went_wrong,n.isLoading=!1,console.error("Action failed:",u)}};l(0)}function ce(e,t,s,i){const n=e.actionStates[s],o=t.dataTransfer?t.dataTransfer.files[0]:t.target.files[0];if(!o)return;const r=e.findPageConfigById(s,e.sections)?.accept_file_type;if(r){const d=o.name.split(".").pop().toLowerCase(),p={csv:"text/csv",json:"application/json"}[r];if(d!==r||p&&o.type!==p){n.status="error",n.success=!1,n.message=`Invalid file type. Please upload a .${r} file.`,t.target&&(t.target.value=null);return}}t.target&&(t.target.value=null),n.status="uploading",n.isLoading=!0,n.message="",n.success=null,n.uploadProgress=0;const c=new FormData;c.append("action",window.ayecodeSettingsFramework.file_upload_ajax_action),c.append("nonce",window.ayecodeSettingsFramework.tool_nonce),c.append("import_file",o);const l=new XMLHttpRequest;l.open("POST",window.ayecodeSettingsFramework.ajax_url,!0),l.upload.onprogress=d=>{d.lengthComputable&&(n.uploadProgress=Math.round(d.loaded*100/d.total))},l.onload=()=>{if(n.isLoading=!1,l.status>=200&&l.status<300){const d=JSON.parse(l.responseText);d.success?(n.status="selected",n.uploadedFilename=d.data.filename,n.message=d.data.message,e.settings[i]=d.data.filename):(n.status="error",n.success=!1,n.message=d.data.message||e.strings.file_upload_failed)}else n.status="error",n.success=!1,n.message=`Upload error: ${l.statusText}`},l.onerror=()=>{n.isLoading=!1,n.status="error",n.success=!1,n.message="A network error occurred during upload."},l.send(c)}async function le(e,t,s){const i=e.actionStates[t];if(!i?.uploadedFilename)return;const n=i.uploadedFilename;i.status="idle",i.uploadedFilename="",i.message="",i.success=null,e.settings[s]="";try{await fetch(window.ayecodeSettingsFramework.ajax_url,{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:new URLSearchParams({action:window.ayecodeSettingsFramework.file_delete_ajax_action,nonce:window.ayecodeSettingsFramework.tool_nonce,filename:n})})}catch(o){console.error("Error deleting temp file:",o)}}function _(e,t,s="info"){window.wp?.data?.dispatch("core/notices")?window.wp.data.dispatch("core/notices").createNotice(s==="error"?"error":"success",t,{type:"snackbar",isDismissible:!0}):window.aui_toast?.("asf-settings-framework-"+s,s,t)}function de(e){const t=localStorage.getItem("asf_theme"),s=window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches;e.theme=t||(s?"dark":"light"),e.$watch?.("theme",i=>localStorage.setItem("asf_theme",i))}function ue(e){e.theme=e.theme==="light"?"dark":"light"}function C(e){e.$nextTick(()=>{console.log("Re-initializing..."),typeof window.aui_init=="function"&&window.aui_init(),me(e)})}function ge(e,t){if(e.isChangingView)return;e.isChangingView=!0;const s=e.$refs.settingsPane,i=150;s&&(s.classList.remove("fade-in"),s.classList.add("fade-out")),setTimeout(()=>{t(),e.$nextTick(()=>{s&&(s.offsetWidth,s.classList.remove("fade-out"),s.classList.add("fade-in")),C(e),setTimeout(()=>{e.isChangingView=!1},i)})},i)}function he(e){window.addEventListener("beforeunload",t=>{(e.hasUnsavedChanges||e.isActionRunning)&&(t.preventDefault(),t.returnValue="A task is running or you have unsaved changes. Are you sure you want to leave?")}),document.addEventListener("keydown",t=>{(t.ctrlKey||t.metaKey)&&t.key==="k"&&(t.preventDefault(),e.searchModal?.show?.())}),window.addEventListener("hashchange",()=>e.handleUrlHash())}window.activeChoicesInstances=window.activeChoicesInstances||{},window.activeChoicesWatchers=window.activeChoicesWatchers||{};function pe(e,t){setTimeout(()=>{const s=e.$refs[t];if(!s||!s.classList.contains("aui-select2"))return;window.activeChoicesWatchers[t]&&window.activeChoicesWatchers[t](),window.activeChoicesInstances[t]&&window.activeChoicesInstances[t].destroy();const i=e.editingField&&e.editingField._uid?"editingField":"settings",n=e[i],o=window.aui_get_choices_config?.(s),a=new window.Choices(s,o);window.activeChoicesInstances[t]=a,a.setChoiceByValue(String(n[t])),s.addEventListener("change",()=>{n[t]=a.getValue(!0)});const r=e.$watch(`${i}['${t}']`,c=>{if(!a.initialised)return;const l=a.getValue(!0);c!==l&&a.setChoiceByValue(String(c))});window.activeChoicesWatchers[t]=r},0)}function fe(e,t){setTimeout(()=>{const s=e.$refs[t];if(!s)return;window.activeChoicesWatchers[t]&&window.activeChoicesWatchers[t](),window.activeChoicesInstances[t]&&window.activeChoicesInstances[t].destroy();const i=e.editingField&&e.editingField._uid?"editingField":"settings",n=e[i];Array.isArray(n[t])||(n[t]=[]);const o=window.aui_get_choices_config?.(s),a=new window.Choices(s,o);window.activeChoicesInstances[t]=a,a.setChoiceByValue(n[t]),s.addEventListener("change",()=>{const c=a.getValue(!0),l=n[t];JSON.stringify(l)!==JSON.stringify(c)&&(l.length=0,c.forEach(d=>l.push(d)))});const r=e.$watch(`${i}['${t}']`,c=>{if(!a.initialised)return;const l=a.getValue(!0);JSON.stringify(c)!==JSON.stringify(l)&&a.setChoiceByValue(c)});window.activeChoicesWatchers[t]=r},0)}function me(e){document.querySelectorAll('input[data-aui-init="iconpicker"]').forEach(s=>{const i=()=>{const a=s.id;if(!a)return;const r=s.value;e.editingField&&e.editingField._uid&&Object.prototype.hasOwnProperty.call(e.editingField,a)?e.editingField[a]!==r&&(e.editingField[a]=r):e.settings[a]!==r&&(e.settings[a]=r)},n=()=>{s.dispatchEvent(new Event("change",{bubbles:!0})),i()};s.addEventListener("input",i),s.addEventListener("change",i),s.addEventListener("iconpickerSelected",n),s.addEventListener("iconpickerChange",n),s.addEventListener("change.bs.iconpicker",n),s.addEventListener("iconpicker-selected",n);const o=s.closest(".input-group")?.querySelector(".input-group-addon, .input-group-text");o&&o.addEventListener("click",()=>{setTimeout(n,0)})})}function we(e,t){if(typeof window.wp>"u"||typeof window.wp.media>"u"){alert("WordPress media library not available.");return}const s=window.wp.media({title:"Select or Upload an Image",button:{text:"Use this image"},multiple:!1});s.on("select",()=>{const i=s.state().get("selection").first().toJSON();e.settings[t]=i.id;const n=i.sizes?.thumbnail?.url||i.sizes?.medium?.url||i.url;e.imagePreviews[t]=n}),s.open()}function _e(e,t){e.settings[t]=null,delete e.imagePreviews[t]}function ye(e,t,s,i){if(typeof window.GeoDirectoryMapManager>"u"||typeof window.geodirMapData>"u"){console.error(`Cannot initialize GD Map for '${t}': GeoDirectory map scripts are not loaded on this page.`);const n=e.$refs[t+"_map_canvas"];n&&(n.innerHTML='<div class="alert alert-danger m-3">Error: GeoDirectory map scripts are not available.</div>');return}e.$nextTick(()=>{const n=e.$refs[t+"_map_canvas"];if(!n){console.error(`Map container not found for field '${t}'.`);return}const o=JSON.parse(JSON.stringify(window.geodirMapData));o.lat=e.settings[s]||o.default_lat,o.lng=e.settings[i]||o.default_lng,o.lat_lng_blank=!e.settings[s]&&!e.settings[i],o.prefix=`${t}_`;const a={onMarkerUpdate:r=>{e.settings[s]=parseFloat(r.lat).toFixed(6),e.settings[i]=parseFloat(r.lng).toFixed(6)}};window.GeoDirectoryMapManager.initMap(n.id,o,a)})}function D(e,t){if(!t.show_if)return!0;try{return O(e,t.show_if)}catch(s){return console.error(`Error evaluating show_if for "${t.id}":`,s),!0}}function O(e,t){const i=t.replace(/\[%(\w+)%\]/g,(n,o)=>{const a=e[o];return typeof a=="string"?`'${a.replace(/'/g,"\\'")}'`:typeof a=="boolean"||typeof a=="number"?a:"null"}).split("||");for(const n of i){const o=n.split("&&");let a=!0;for(const r of o)if(!I(r.trim())){a=!1;break}if(a)return!0}return!1}function I(e){if(!["==","!=",">","<",">=","<="].some(c=>e.includes(c))){let c;try{c=JSON.parse(e.toLowerCase())}catch{c=e.trim()!==""}return!!c}const t=e.match(/^(.*?)\s*(==|!=|>|<|>=|<=)\s*(.*)$/);if(!t)throw new Error(`Invalid comparison: "${e}"`);let[,s,i,n]=t;const o=c=>(c=c.trim(),c.startsWith("'")&&c.endsWith("'")||c.startsWith('"')&&c.endsWith('"')?c.slice(1,-1):!isNaN(c)&&c!==""?parseFloat(c):c==="true"?!0:c==="false"?!1:c==="null"?null:c),a=o(s),r=o(n);switch(i){case"==":return a==r;case"!=":return a!=r;case">":return a>r;case"<":return a<r;case">=":return a>=r;case"<=":return a<=r;default:throw new Error("op")}}function be(e,t){e.$nextTick(()=>{const s=document.getElementById(t);if(!s)return;const i=s.closest(".row, .py-4, .border-bottom");i&&(i.scrollIntoView({behavior:"smooth",block:"center"}),i.classList.add("highlight-setting"),setTimeout(()=>i.classList.remove("highlight-setting"),3500))})}function E(e,t){for(const s of t){if(s.id===e)return s;if(s.subsections){const i=E(e,s.subsections);if(i)return i}}return null}window.__ASF_NULL_FIELD=new Proxy({},{get:(e,t)=>t==="hasOwnProperty"?s=>Object.prototype.hasOwnProperty.call(e,s):"",has:()=>!0});function k(e){return e.reduce((t,s)=>(s.id&&(t[s.id]=s.default!==void 0?s.default:null),s.type==="group"&&s.fields&&Object.assign(t,k(s.fields)),s.type==="accordion"&&s.fields&&s.fields.forEach(i=>{i.fields&&Object.assign(t,k(i.fields))}),t),{})}function ve(){return{config:window.ayecodeSettingsFramework?.config||{},originalSettings:{},settings:{},strings:window.ayecodeSettingsFramework?.strings||{},imagePreviews:{},originalImagePreviews:{},currentSection:"",currentSubsection:"",searchQuery:"",isLoading:!1,sidebarOpen:!1,theme:"light",isChangingView:!1,searchModalEl:null,searchModal:null,allFields:[],customSearchLinks:[],sections:[],actionStates:{},isContentLoading:!1,loadedContentCache:{},accordionStates:{},leftColumnView:"field_list",editingField:null,sortIteration:0,activeSyncListeners:[],initialTargetValues:{},isValidating:!1,lastEditFieldCall:0,init(){de(this),this.editingField=window.__ASF_NULL_FIELD,this.customSearchLinks=window.ayecodeSettingsFramework?.custom_search_links||[],J(this),this.settings=window.ayecodeSettingsFramework?.settings||{},this.imagePreviews=window.ayecodeSettingsFramework?.image_previews||{},V(this),this.sections.forEach(e=>{if(e.type==="form_builder"){Array.isArray(this.settings[e.id])||(this.settings[e.id]=[]);const t=e.templates.flatMap(s=>s.options);this.settings[e.id].forEach(s=>{const i=t.find(n=>n.id===s.template_id);i&&(s.fields=i.fields,s._template_icon=i.icon,i.fields.forEach(n=>{s[n.id]===void 0&&n.default!==void 0&&(s[n.id]=n.default),n.type==="toggle"&&s[n.id]===!0&&(s[n.id]=1)}))})}}),this.originalSettings=JSON.parse(JSON.stringify(this.settings)),this.originalImagePreviews=JSON.parse(JSON.stringify(this.imagePreviews)),ie(this),N(this),X(this),he(this),C(this),this.$watch("leftColumnView",(e,t)=>{e==="field_list"&&t==="field_settings"&&this.clearSyncListeners()})},get activePageConfig(){return K(this)},get hasUnsavedChanges(){return H(this)},get currentSectionData(){return $(this)},get currentSubsectionData(){return T(this)},get isSettingsPage(){return P(this)},get isActionRunning(){return oe(this)},get groupedSearchResults(){return ee(this)},get duplicateKeys(){const e=this.activePageConfig?.unique_key_property;if(!e)return[];const s=(this.settings[this.activePageConfig.id]||[]).reduce((i,n)=>{const o=n[e];return o&&(i[o]=(i[o]||0)+1),i},{});return Object.keys(s).filter(i=>s[i]>1)},get parentFields(){return(this.settings[this.activePageConfig?.id]||[]).filter(t=>!t._parent_id||t._parent_id==0)},childFields(e){return(this.settings[this.activePageConfig?.id]||[]).filter(s=>s._parent_id==e)},get otherFields(){return!this.activePageConfig||this.activePageConfig.type!=="form_builder"||!this.editingField?._uid?[]:(this.settings[this.activePageConfig.id]||[]).filter(t=>t._uid!==this.editingField._uid).map(t=>({label:t.label,value:t.key||t.htmlvar_name||t._uid,_uid:t._uid}))},confirmWithThreeButtons(){return new Promise(e=>{window.asfConfirmResolve=s=>{const i=document.querySelector(".aui-modal.show");if(i){const n=bootstrap.Modal.getInstance(i);n&&n.hide()}e(s)},aui_modal("",`
  ...
  `}g("password",e=>{const t=e.class||"",s=w(e),i=f(e),n=`<input type="password" autocomplete="new-password" class="form-control ${t}" id="${e.id}" name="${e.id}" x-model="settings.${e.id}" placeholder="${e.placeholder||""}" ${s}>`,o=e.input_group_right?`<div class="input-group">${n}${e.input_group_right}</div>`:n;return`
    <div class="row align-items-center rounded">
      <div class="col-md-4">
        <label for="${e.id}" class="form-label fw-bold mb-0">${e.label||e.id}</label>
        ${e.description?`<p class="form-text text-muted mt-1 mb-0">${e.description}</p>`:""}
  ...
  `}),g("textarea",e=>{const t=e.rows||5,s=e.class||"",i=w(e),n=z(e.placeholder||""),o=f(e);let a="";if(e.active_placeholder&&e.placeholder){const r=JSON.stringify(e.placeholder);a=`
  ...
  `}),g("toggle",(e,t="settings")=>{const s=w(e),i=f(e),o=`${`${t}.${e.id}`} = $event.target.checked ? 1 : 0;`;return`
    <div class="row align-items-center rounded">
      <div class="col-md-4">
        <label for="${e.id}" class="form-label fw-bold mb-0">${e.label||e.id}</label>
        ${e.description?`<p class="form-text text-muted mt-1 mb-0">${e.description}</p>`:""}
  ...
  `}),g("range",e=>{const t=e.min||0,s=e.max||100,i=e.step||1,n=w(e),o=f(e);return`
    <div class="row align-items-center rounded">
      <div class="col-md-4">
        <label for="${e.id}" class="form-label fw-bold mb-0">${e.label||e.id}</label>
        ${e.description?`<p class="form-text text-muted mt-1 mb-0">${e.description}</p>`:""}
  ...
  `}),g("checkbox",e=>{const t=w(e),s=f(e);return`
    <div class="row">
      <div class="col-md-4">
  ...
  `}),g("color",e=>{const t=w(e),s=f(e),i=e.default?`
    <button 
      type="button" 
  ...
  `}),g("font-awesome",e=>{const t=e.class||"",s=w(e),i=f(e),n=e.input_group_right||"";return`
    <div class="row align-items-center rounded">
      <div class="col-md-4">
        <label for="${e.id}" class="form-label fw-bold mb-0">${e.label||e.id}</label>
        ${e.description?`<p class="form-text text-muted mt-1 mb-0">${e.description}</p>`:""}
  ...
  `}),g("gd_map",e=>{if(!e.lat_field||!e.lng_field)return`<div class="alert alert-danger">Error: 'gd_map' field type requires 'lat_field' and 'lng_field' properties.</div>`;const t=`${e.id}_map_canvas`,s=w(e),i=f(e);return`
  ...
  `}),g("custom_renderer",e=>!e.renderer_function||typeof e.renderer_function!="string"?`<div class="alert alert-danger">Error: 'custom_renderer' field type requires a 'renderer_function' property specifying the function name.</div>`:typeof window[e.renderer_function]!="function"?`<div class="alert alert-danger">Error: The specified renderer function '${e.renderer_function}' was not found or is not a function.</div>`:window[e.renderer_function](e)),g("conditions",e=>{const t=e&&e.warning_key?String(e.warning_key):null,s=Array.isArray(e&&e.warning_fields)?e.warning_fields.slice(0):[],i=t&&/^[A-Za-z_$][A-Za-z0-9_$]*$/.test(t)?t:null,n=i&&s.length?s.map(a=>`editingField && editingField.${i}===${JSON.stringify(a)}`).join(" || "):"",o=n.replace(/"/g,"&quot;");return`
    ...
    `}),g("file",e=>{const t=w(e),s=e.accept||"",i=f(e);return`
    <div class="row align-items-center rounded">
      <div class="col-md-4">
        <label for="${e.id}" class="form-label fw-bold mb-0">${e.label||e.id}</label>
        ${e.description?`<p class="form-text text-muted mt-1 mb-0">${e.description}</p>`:""}
